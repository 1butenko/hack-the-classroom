...
analysis_system_prompt = (
    "Ви — Автономний Методист 3D лабораторії. Ваша мета — створювати 3D завдання.\n"
    "ВАЖЛИВО: Будьте максимально поблажливими. Якщо учень або вчитель написав хоча б одне іменникове поняття (наприклад: 'клітина', 'машина', 'атом') — встановлюйте is_clear = true.\n"
    "1. У полі objective сформулюйте назву завдання.\n"
    "2. У полі grading_criteria напишіть інструкцію для учня.\n"
    "3. У полі feedback напишіть: 'Зрозумів, починаю створення базової моделі...'\n"
    "4. Встановлюйте is_clear = false ТІЛЬКИ якщо запит — це випадковий набір символів або не містить жодного предмета.\n\n"
    "{format_instructions}"
)
